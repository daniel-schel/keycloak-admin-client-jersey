...
/**
 * The type Scope permission resource.
 *
 * Based on a fork of keycloak-amdin-client originally created by psilva@redhat.com.
 *
 * @author daniel-schel
 */
public class ScopePermissionResource extends AbstractResource {
     ...
     */
    protected ScopePermissionResource(WebResource target) {
        super(target);
    }

    public ScopePermissionResource(WebResource target, String path) {
        super(target);
        this.path = path;
    }
...
//    @NoCache
    ...
    public void update(ScopePermissionRepresentation representation) {
        throw new UnsupportedOperationException();
    }
