...
/**
 * The type Role policy resource.
 *
 * Based on a fork of keycloak-amdin-client originally created by psilva@redhat.com.
 *
 * @author daniel-schel
 */
public class RolePolicyResource extends AbstractResource {
     ...
     */
    protected RolePolicyResource(WebResource target) {
        super(target);
    }

    /**
     * Instantiates a new Role policy resource.
     *
     * @param target the target
     * @param path   the path
     */
    public RolePolicyResource(WebResource target, String path) {
        super(target);
        this.path = path;
    }
    ...
    public void update(RolePolicyRepresentation representation) {
        throw new UnsupportedOperationException();
    }
