...
/**
 * The type Rule policy resource.
 *
 * Based on a fork of keycloak-amdin-client originally created by psilva@redhat.com.
 *
 * @author daniel-schel
 */
public class RulePolicyResource extends AbstractResource {
     ...
     */
    protected RulePolicyResource(WebResource target) {
        super(target);
    }

    /**
     * Instantiates a new Rule policy resource.
     *
     * @param target the target
     * @param path   the path
     */
    public RulePolicyResource(WebResource target, String path) {
        super(target);
        this.path = path;
    }
    ...
    public void update(RulePolicyRepresentation representation) {
        throw new UnsupportedOperationException();
    }
