...
/**
 * The type Js policy resource.
 *
 * Based on a fork of keycloak-amdin-client originally created by psilva@redhat.com.
 *
 * @author daniel-schel
 */
public class JSPolicyResource extends AbstractResource {
     ...
     */
    protected JSPolicyResource(WebResource target) {
        super(target);
    }

    /**
     * Instantiates a new Js policy resource.
     *
     * @param target the target
     * @param path   the path
     */
    public JSPolicyResource(WebResource target, String path) {
        super(target);
        this.path = path;
    }
    ...
    public void update(JSPolicyRepresentation representation) {
        throw new UnsupportedOperationException();
    }
