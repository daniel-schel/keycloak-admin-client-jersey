...
/**
 * The type Client policies policies resource.
 *
 * Based on a fork of keycloak-amdin-client originally created by takashi.norimatsu.ws@hitachi.com.
 *
 * @author daniel-schel
 */
public class ClientPoliciesPoliciesResource extends AbstractResource {

    private String path = "";

    /**
     * Instantiates a new Client policies policies resource.
     *
     * @param target the target
     */
    protected ClientPoliciesPoliciesResource(WebResource target) {
        super(target);
    }
     ...
     * @param path   the path
     */
    public ClientPoliciesPoliciesResource(WebResource target, String path) {
        super(target);
        this.path = path;
    }
