...
/**
 * The type Client policy resource.
 *
 * Based on a fork of keycloak-amdin-client originally created by psilva@redhat.com.
 *
 * @author daniel-schel
 */
public class ClientPolicyResource extends AbstractResource {
     ...
     */
    protected ClientPolicyResource(WebResource target) {
        super(target);
    }

    /**
     * Instantiates a new Client policy resource.
     *
     * @param target the target
     * @param path   the path
     */
    public ClientPolicyResource(WebResource target, String path) {
        super(target);
        this.path = path;
    }
    ...
    public void update(ClientPolicyRepresentation representation) {
        throw new UnsupportedOperationException();
    }
