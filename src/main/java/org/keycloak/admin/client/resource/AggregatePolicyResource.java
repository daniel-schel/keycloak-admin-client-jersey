...
/**
 * The type Aggregate policy resource.
 *
 * Based on a fork of keycloak-amdin-client originally created by psilva@redhat.com.
 *
 * @author daniel-schel
 */
public class AggregatePolicyResource extends AbstractResource {
     ...
     */
    protected AggregatePolicyResource(WebResource target) {
      super(target);
    }

    /**
     * Instantiates a new Aggregate policy resource.
     *
     * @param target the target
     * @param path   the path
     */
    public AggregatePolicyResource(WebResource target, String path) {
        super(target);
        this.path = path;
    }
    ...
    public void update(AggregatePolicyRepresentation representation) {
        throw new UnsupportedOperationException();
    }
