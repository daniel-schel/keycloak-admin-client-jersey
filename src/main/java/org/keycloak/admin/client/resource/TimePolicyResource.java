...
/**
 * The type Time policy resource.
 *
 * Based on a fork of keycloak-amdin-client originally created by psilva@redhat.com.
 *
 * @author daniel-schel
 */
public class TimePolicyResource extends AbstractResource {
     ...
     */
    protected TimePolicyResource(WebResource target) {
        super(target);
    }

    /**
     * Instantiates a new Time policy resource.
     *
     * @param target the target
     * @param path   the path
     */
    public TimePolicyResource(WebResource target, String path) {
        super(target);
        this.path = path;
    }
    ...
    public void update(TimePolicyRepresentation representation) {
        throw new UnsupportedOperationException();
    }
