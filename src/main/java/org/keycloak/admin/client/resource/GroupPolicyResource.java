...
/**
 * The type Group policy resource.
 *
 * Based on a fork of keycloak-amdin-client originally created by psilva@redhat.com.
 *
 * @author daniel-schel
 */
public class GroupPolicyResource extends AbstractResource {
     ...
     */
    protected GroupPolicyResource(WebResource target) {
        super(target);
    }

    /**
     * Instantiates a new Group policy resource.
     *
     * @param target the target
     * @param path   the path
     */
    public GroupPolicyResource(WebResource target, String path) {
        super(target);
        this.path = path;
    }
    ...
    public void update(GroupPolicyRepresentation representation) {
        throw new UnsupportedOperationException();
    }
